...
@WebServlet("/GetEligibility")
public class GetEligibility extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Float symbol = Float.parseFloat(request.getParameter("Eligibility"));
		...
		PreparedStatement pst=con.prepareStatement("select * from jobavail where Eligibilty<=?");
